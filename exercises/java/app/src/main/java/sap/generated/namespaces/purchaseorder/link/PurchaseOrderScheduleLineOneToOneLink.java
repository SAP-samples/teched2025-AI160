...
/**
 * Template class to represent entity navigation links of {@link PurchaseOrderScheduleLine PurchaseOrderScheduleLine} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link PurchaseOrderScheduleLineLink PurchaseOrderScheduleLineLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link VdmObject VdmObject}.
 * 
 */
public class PurchaseOrderScheduleLineOneToOneLink<ObjectT extends VdmObject<?> >
    extends PurchaseOrderScheduleLineLink<ObjectT>
    implements OneToOneLink<PurchaseOrderScheduleLine, ObjectT>
{
     ...
     */
    public PurchaseOrderScheduleLineOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<PurchaseOrderScheduleLine> filter(
        @Nonnull
