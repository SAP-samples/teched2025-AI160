...
package com.sap.generated.namespaces.purchaseorder.field;
...
/**
 * Template class to represent entity fields of the Entity {@link PurchaseOrderScheduleLine PurchaseOrderScheduleLine}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PurchaseOrderScheduleLineField<FieldT >
    extends EntityField<PurchaseOrderScheduleLine, FieldT>
    implements PurchaseOrderScheduleLineSelectable
{
     ...
     */
    public PurchaseOrderScheduleLineField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PurchaseOrderScheduleLineField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
