...
/**
 * Template class to represent entity navigation links of {@link PurchaseOrderItem PurchaseOrderItem} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link PurchaseOrderItemLink PurchaseOrderItemLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link VdmObject VdmObject}.
 * 
 */
public class PurchaseOrderItemOneToOneLink<ObjectT extends VdmObject<?> >
    extends PurchaseOrderItemLink<ObjectT>
    implements OneToOneLink<PurchaseOrderItem, ObjectT>
{
     ...
     */
    public PurchaseOrderItemOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<PurchaseOrderItem> filter(
        @Nonnull
