...
/**
 * Template class to represent entity fields of the Entity {@link PurchaseOrderItemNote PurchaseOrderItemNote}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PurchaseOrderItemNoteField<FieldT >
    extends EntityField<PurchaseOrderItemNote, FieldT>
    implements PurchaseOrderItemNoteSelectable
{
     ...
     */
    public PurchaseOrderItemNoteField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PurchaseOrderItemNoteField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
