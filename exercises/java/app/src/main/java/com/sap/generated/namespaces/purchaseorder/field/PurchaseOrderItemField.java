...
/**
 * Template class to represent entity fields of the Entity {@link PurchaseOrderItem PurchaseOrderItem}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PurchaseOrderItemField<FieldT >
    extends EntityField<PurchaseOrderItem, FieldT>
    implements PurchaseOrderItemSelectable
{
     ...
     */
    public PurchaseOrderItemField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PurchaseOrderItemField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
