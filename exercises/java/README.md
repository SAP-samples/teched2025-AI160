...
## 2. Project Structure
The [project](../src/main/java/com/sap/demo) used for this session is a Purchase Order Management application with AI agent capabilities.
...
- **Main class ([Application.java](../src/main/java/com/sap/demo/Application.java))**: This class governs the main application flow of the demo app you are using.

- **The two task classes([GetPurchaseOrdersTask.java](../src/main/java/com/sap/demo/GetPurchaseOrdersTask.java) and [EscalateTask.java](../src/main/java/com/sap/demo/EscalateTask.java))**: These classes contain the code to run the agent we are using in this demo.
  **These are the only classes you have to change to solve the exercises.**

- **UI ([ui/](../src/main/java/com/sap/demo/ui))**: The code to generate the frontend for interacting with the AI agent.

- **Tools ([tools/](../src/main/java/com/sap/demo/tools))**: A collection of tools that the AI agent will use during the exercises.
...
- [Exercise 3 - Harmonization, Filtering, and Prompt Shield](./ex3/README.md)
